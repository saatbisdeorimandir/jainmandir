...
export default function TrustSection({ lang, dict, siteConfig, members }: TrustSectionProps) {
    return (
        <div id="trust" className="bg-gradient-to-b from-stone-50 via-white to-stone-50 scroll-mt-16">
            {/* Hero Header */}
