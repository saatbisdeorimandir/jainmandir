...
export default function EventsSection({ dict, siteConfig }: EventsSectionProps) {
    return (
        <div id="events" className="max-w-7xl mx-auto px-4 py-12 scroll-mt-16">
